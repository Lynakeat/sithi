...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyAddress.facebook_profile'
        db.add_column('companies_companyaddress', 'facebook_profile',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyAddress.facebook_profile'
        db.delete_column('companies_companyaddress', 'facebook_profile')
