...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'CompanyAddress'
        db.create_table('companies_companyaddress_categories', (
        ...
        db.create_unique('companies_companyaddress_categories', ['companyaddress_id', 'category_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'CompanyAddress'
        db.delete_table('companies_companyaddress_categories')
