...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.enable_products'
        db.add_column('companies_company', 'enable_products',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.enable_reviews'
        db.add_column('companies_company', 'enable_reviews',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.enable_courses'
        db.add_column('companies_company', 'enable_courses',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.enable_products'
        db.delete_column('companies_company', 'enable_products')

        # Deleting field 'Company.enable_reviews'
        db.delete_column('companies_company', 'enable_reviews')

        # Deleting field 'Company.enable_courses'
        db.delete_column('companies_company', 'enable_courses')
