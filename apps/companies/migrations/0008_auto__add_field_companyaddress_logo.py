...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyAddress.logo'
        db.add_column('companies_companyaddress', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyAddress.logo'
        db.delete_column('companies_companyaddress', 'logo')
