...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CompanyAddress', fields ['slug']
        db.create_unique('companies_companyaddress', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanyAddress', fields ['slug']
        db.delete_unique('companies_companyaddress', ['slug'])
