...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyAddress.hours'
        db.add_column('companies_companyaddress', 'hours',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyAddress.hours'
        db.delete_column('companies_companyaddress', 'hours')
