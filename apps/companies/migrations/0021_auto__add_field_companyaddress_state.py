...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyAddress.state'
        db.add_column('companies_companyaddress', 'state',
                      self.gf('django.contrib.localflavor.us.models.USStateField')(default='TN', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyAddress.state'
        db.delete_column('companies_companyaddress', 'state')
