...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.is_partner'
        db.add_column('companies_company', 'is_partner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Company.is_partner'
        db.delete_column('companies_company', 'is_partner')
