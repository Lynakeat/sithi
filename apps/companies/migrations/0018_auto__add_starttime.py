...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StartTime'
        db.create_table('companies_starttime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Course'])),
            ('day_of_week', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('companies', ['StartTime'])


    def backwards(self, orm):
        # Deleting model 'StartTime'
        db.delete_table('companies_starttime')
