...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.enable_pricing'
        db.add_column('companies_company', 'enable_pricing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.enable_pricing'
        db.delete_column('companies_company', 'enable_pricing')
