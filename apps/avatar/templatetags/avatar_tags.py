...
from activebuys.apps.avatar.settings import (AVATAR_GRAVATAR_BACKUP, AVATAR_GRAVATAR_DEFAULT,
                             AVATAR_DEFAULT_SIZE)
from activebuys.apps.avatar.util import get_primary_avatar, get_default_avatar_url, cache_result
