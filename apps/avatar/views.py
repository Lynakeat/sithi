...
from activebuys.apps.avatar.forms import PrimaryAvatarForm, DeleteAvatarForm, UploadAvatarForm
from activebuys.apps.avatar.models import Avatar
from activebuys.apps.avatar.settings import AVATAR_MAX_AVATARS_PER_USER, AVATAR_DEFAULT_SIZE
from activebuys.apps.avatar.signals import avatar_updated
from activebuys.apps.avatar.util import get_primary_avatar, get_default_avatar_url
