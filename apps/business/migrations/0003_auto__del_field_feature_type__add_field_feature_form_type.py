...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feature.form_type'
        db.add_column('business_feature', 'form_type', self.gf('django.db.models.fields.CharField')(default='business', max_length=30), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Feature.form_type'
        db.delete_column('business_feature', 'form_type')
    ...
    models = {
        'business.feature': {
            ...
            'form_type': ('django.db.models.fields.CharField', [], {'default': "'business'", 'max_length': '30'}),
