...
from activebuys.apps.follow.registry import model_map
from activebuys.apps.follow.signals import followed, unfollowed
import inspect
...
post_save.connect(follow_dispatch, dispatch_uid='activebuys.apps.follow.follow_dispatch', sender=Follow)
post_delete.connect(unfollow_dispatch, dispatch_uid='activebuys.apps.follow.unfollow_dispatch', sender=Follow)
