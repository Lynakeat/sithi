...
from activebuys.apps.follow.registry import registry, model_map
...
def follow_link(object):
    return reverse('activebuys.apps.follow.views.toggle', args=[object._meta.app_label, object._meta.object_name.lower(), object.pk])
