...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Widget', fields ['api_key']
        db.create_unique('widget_widget', ['api_key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Widget', fields ['api_key']
        db.delete_unique('widget_widget', ['api_key'])
    ...
    models = {
        ...
        'widget.widget': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'31JXLDGDVE'", 'max_length': '10', 'unique': 'True'}),
