...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Widget.api_key'
        db.alter_column('widget_widget', 'api_key', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))


    def backwards(self, orm):
        
        # Changing field 'Widget.api_key'
        db.alter_column('widget_widget', 'api_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))
    ...
    models = {
        ...
        'widget.widget': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'NUO3ZYS1UXGX8RNLU6W51IAQZ'", 'max_length': '25', 'unique': 'True'}),
            'bg_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_color': ('django.db.models.fields.CharField', [], {'default': "'#6A8C0F'", 'max_length': '7'}),
            'link_hover_color': ('django.db.models.fields.CharField', [], {'default': "'#383838'", 'max_length': '7'}),
