...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_account', 'gender',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_account', 'gender')
    ...
    models = {
        ...
        'deals.deal': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)', 'db_index': 'True'}),
            'expire_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
