...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.active_level'
        db.add_column('accounts_account', 'active_level',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.active_level'
        db.delete_column('accounts_account', 'active_level')
    ...
    models = {
        'accounts.account': {
            ...
            'active_level': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3'}),
            ...
            'interests': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['companies.Category']", 'symmetrical': 'False'}),
        ...
        'deals.deal': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)', 'db_index': 'True'}),
            'expire_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
