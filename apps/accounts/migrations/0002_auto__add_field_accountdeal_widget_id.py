...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountDeal.widget_id'
        db.add_column('accounts_accountdeal', 'widget_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountDeal.widget_id'
        db.delete_column('accounts_accountdeal', 'widget_id')
