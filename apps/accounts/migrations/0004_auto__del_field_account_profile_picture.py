...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.profile_picture'
        db.delete_column('accounts_account', 'profile_picture')


    def backwards(self, orm):
        # Adding field 'Account.profile_picture'
        db.add_column('accounts_account', 'profile_picture',
    ...
    models = {
        ...
        'deals.deal': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)', 'db_index': 'True'}),
            'expire_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
