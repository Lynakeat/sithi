...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_account_interests', (
            ...
            ('category', models.ForeignKey(orm['companies.category'], null=False))
        ))
        db.create_unique('accounts_account_interests', ['account_id', 'category_id'])
    ...
    models = {
        ...
        'deals.deal': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)', 'db_index': 'True'}),
            'expire_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
