...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_account', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.city'
        db.add_column('accounts_account', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.state'
        db.add_column('accounts_account', 'state',
                      self.gf('django.contrib.localflavor.us.models.USStateField')(default='TN', max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.address'
        db.delete_column('accounts_account', 'address')

        # Deleting field 'Account.city'
        db.delete_column('accounts_account', 'city')

        # Deleting field 'Account.state'
        db.delete_column('accounts_account', 'state')
    ...
    models = {
        'accounts.account': {
            ...
            'state': ('django.contrib.localflavor.us.models.USStateField', [], {'default': "'TN'", 'max_length': '2', 'null': 'True', 'blank': 'True'}),
        ...
        'deals.deal': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)', 'db_index': 'True'}),
            'expire_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
